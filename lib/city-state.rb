...
module CS
  ...
  @countries, @states, @cities, @cities_prov, @provinces = [{}, {}, {}, {}, {}]
  ...
  def self.install(country)
    ...
    if country == "IT"
      ...
      File.chmod(0666, provices_fn, cities_prov_fn) # force permissions to rw_rw_rw_ (issue #3)
    end
  ...
  def self.cities_prov(province, country = nil)
    ...
    if @cities_prov[country].blank?
      ...
      self.install(country) if ! File.exists? cities_prov_fn
